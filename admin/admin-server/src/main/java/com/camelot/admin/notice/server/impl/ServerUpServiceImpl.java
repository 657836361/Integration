...
@Service
@Slf4j
public class ServerUpServiceImpl implements ServerInstanceService, InitializingBean {

    @Override
    public void execute(String serverName, String serverStatus) {
        log.info("发送 服务上线 的通知！");
        System.out.println(serverName+"服务上线了");
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        ServerInstanceFactory.register(InstanceTypeEnum.UP.getType(),this);
    }
}
